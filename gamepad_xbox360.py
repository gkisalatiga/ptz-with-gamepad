...
# 
# For XBOX 360 Joystick types
# Unlike the other gamepad script in this repository,
# this script does not have any multithreading.
# This is such because on some Windows 10 and 11 machines,
# the multithreading causes the XBOX 360 input events
